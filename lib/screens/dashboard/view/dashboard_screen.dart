                    ...
                    constraint.maxWidth >= PlatformSizes.minMediumScreenWidth
                        ? Expanded(
                            child: Column(
                              mainAxisSize: MainAxisSize.min,
                              children: [
                                SvgPicture.asset(Assets.dashboardWeatherWidget),
                                SvgPicture.asset(Assets.dashboardWeatherWidget),
                                SvgPicture.asset(Assets.dashboardWeatherWidget),
                              ],
                            ),
                      ...
                      GridView.builder(
                        ...
                        itemBuilder: (BuildContext context, int index) {
                          return GardenerInfoTiles(
                            gardener:
                                ConstantLists.gardenersList[index].gardener,
                            location:
                                ConstantLists.gardenersList[index].location,
                            availability:
                                ConstantLists.gardenersList[index].availability,
                            compliance:
                                ConstantLists.gardenersList[index].compliance,
                          );
                        },
                      ),
                      20.ph,
